...
import "../styling/VisionsOfChrist.css";
import princeOfPeace from "../images/Jesus photo.png";

function VisionsOfChrist(){
    return(
        <div className="bornAgainFullPage">
            ...
            <div className="bornAgainDiv">
                ...
                <h3 className="deBold">“For all have sinned and fall short of the glory of God.” – Romans 3:23</h3>
                <h2 className="step">Step 2: Believe in Jesus Christ</h2>
                <h3 className="deBold">“For God so loved the world that He gave His one and only Son, that whoever believes in Him shall not perish but have eternal life.” – John 3:16</h3>
                <h2 className="step">Step 3: Confess and Commit Your Life to Christ</h2>
                <h3 className="deBold">“If you declare with your mouth, ‘Jesus is Lord,’ and believe in your heart that God raised Him from the dead, you will be saved.” – Romans 10:9</h3>
                
                <h2 className="visionTitle">Akiane Kramarik’s Vision of Jesus and Colton Burpo’s Stunning Confirmation</h2>
                <h3 className="deBold">In the realm of divine visions and near-death experiences, few stories captivate believers and skeptics alike as much as that of Akiane Kramarik and Colton Burpo...</h3>
                
                <h2 className="visionSubTitle">Akiane Kramarik: A Child Prodigy’s Vision of Christ</h2>
                <h3 className="deBold">Born in 1994 to a Lithuanian mother and an American father, Akiane grew up in an atheistic household...</h3>
                <h3 className="deBold">At the age of four, she began experiencing vivid visions of heaven and Jesus Christ...</h3>
                <h3 className="deBold">By the age of eight, she painted Prince of Peace, a strikingly lifelike portrait of Christ...</h3>
                
                <h2 className="visionSubTitle">Colton Burpo’s Near-Death Experience and Astonishing Recognition</h2>
                <h3 className="deBold">Colton Burpo’s story, widely known from the book Heaven is for Real, added another layer of credibility to Akiane’s depiction of Jesus...</h3>
                <h3 className="deBold">In 2003, at the age of four, Colton suffered a life-threatening medical emergency...</h3>
                <h3 className="deBold">When shown Akiane’s Prince of Peace, Colton pointed and confirmed, “That’s Him. That’s Jesus.”</h3>
                
                <h2 className="visionSubTitle">The Impact of Their Stories</h2>
                <h3 className="deBold">The connection between Akiane and Colton’s experiences has had a profound impact on many...</h3>
                
                <h2 className="visionSubTitle">Skepticism and Faith</h2>
                <h3 className="deBold">While many believers see their stories as divine affirmations, skeptics argue that near-death experiences can be explained by neurological activity...</h3>
                
                <h2 className="visionSubTitle">Conclusion</h2>
                <h3 className="deBold">The convergence of Akiane Kramarik’s vision-driven artwork and Colton Burpo’s near-death experience presents an extraordinary and faith-affirming narrative...</h3>
            </div>
        </div>
...
export default VisionsOfChrist; 
