    ...
    return(
        <div className="bornAgainFullPage">
            ...
            <div className="bornAgainDiv">
                ...
                <h3 className="deBold">The first step in becoming a Christian is understanding that we are all sinners and need God's forgiveness. The Bible says:</h3>
                <h3 className="deBold">“For all have sinned and fall short of the glory of God.” – Romans 3:23</h3>
                <h3 className="deBold">Sin separates us from God, and no amount of good works can save us. But the good news is that God loves us so much that He made a way for us to be forgiven.</h3>
                <h2 className="step">Step 2: Believe in Jesus Christ</h2>
                <h3 className="deBold">God sent His Son, Jesus, to pay the price for our sins. He died on the cross and rose again, proving His power over sin and death. The Bible tells us:</h3>
                ...
                <h3 className="deBold">Salvation is a free gift. We don’t earn it—we simply believe in what Jesus did for us and trust Him as our Lord and Savior.</h3>
                <h2 className="step">Step 3: Confess and Commit Your Life to Christ</h2>
                <h3 className="deBold">The final step is to confess your faith in Jesus and commit to following Him. The Bible promises:</h3>
                ...
                <h3 className="deBold">You can do this by praying a simple prayer, such as:</h3>
                <h3 className="deBold">“Lord Jesus, I know that I am a sinner and need Your forgiveness. I believe You died for my sins and rose again. I ask You to come into my life, be my Lord and Savior, and help me live for You. Amen.”</h3>
                <h3 className="deBold">If you prayed this prayer sincerely, congratulations! You are now a Christian.</h3>
